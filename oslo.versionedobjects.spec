...
Version  : 2.1.0
Release  : 55
URL      : http://tarballs.openstack.org/oslo.versionedobjects/oslo.versionedobjects-2.1.0.tar.gz
Source0  : http://tarballs.openstack.org/oslo.versionedobjects/oslo.versionedobjects-2.1.0.tar.gz
Source1  : http://tarballs.openstack.org/oslo.versionedobjects/oslo.versionedobjects-2.1.0.tar.gz.asc
...
%prep
%setup -q -n oslo.versionedobjects-2.1.0
cd %{_builddir}/oslo.versionedobjects-2.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591379640
...
cp %{_builddir}/oslo.versionedobjects-2.1.0/LICENSE %{buildroot}/usr/share/package-licenses/oslo.versionedobjects/294b43b2cec9919063be1a3b49e8722648424779
